...
<section class="bnr-btm">
   <div class="cust-container1">
      <div class="row">
        <div class="col-md-3">
           <div class="btm-stp">
              <img src="images/m-ico1.png">
              <h6>Become a Tutor</h6>
           </div>
        </div>
        <div class="col-md-3">
           <div class="btm-stp">
              <img src="images/m-ico2.png">
              <h6>Find a Tutor</h6>
           </div>
        </div>
        <div class="col-md-3">
           <div class="btm-stp">
              <img src="images/m-ico3.png">
              <h6>Post Tutoring Request</h6>
           </div>
        </div>
        <div class="col-md-3">
           <div class="btm-stp">
              <img src="images/m-ico4.png">
      ...
      <div class="row">
         <div class="col-md-4">
            <div class="single-bs-grid">
               <img src="images/s-ico1.png">
               <a href="#"><p>Register Yourself</p><img class="w-auto" src="images/go.png"></a>
            </div>
         </div>
         <div class="col-md-4">
            <div class="single-bs-grid">
               <img src="images/s-ico2.png">
               <a href="#"><p>Choose Subject & Tutor</p><img class="w-auto" src="images/go.png"></a>
            </div>
         </div>
         <div class="col-md-4">
            <div class="single-bs-grid">
               <img src="images/s-ico3.png">
               <a href="#"><p>Personalized Learning</p><img class="w-auto" src="images/go.png"></a>
            </div>
         </div>
      </div>
   </div>
               ...
               <a class="t-grid" href="#">
                  ...
                  <div class="dt-price">
                     <div class="lft-price">
                        ...
                        <img src="images/loc1.png">
                        <h3>$455 <span>$3499</span></h3>
                     </div>
                     <div class="pr-tag">
                        <img class="tg1" src="images/tag1.png">
                        <img class="tg2" src="images/tag2.png">
                     </div>
                  </div>
               </a>            
               <a class="t-grid" href="#">
   ...
   <div class="cust-container1">
      <div class="row">
         ...
         <div class="col-md-3">
            <div class="subj1">
               <a href="#">
                  <img src="images/c-ico1.png">
                  <p>Mathematics</p>
               </a>
               <a href="#">
                  <img src="images/c-ico2.png">
                  <p>Physics</p>
               </a>
            </div>
         </div>
         <div class="col-md-6">
            <div class="main-simg">
               <img class="w-100" src="images/crs-main.png">
            </div>
         </div>
         <div class="col-md-3">
            <div class="subj2">
               <a href="#">
                  <img src="images/c-ico3.png">
                  <p>Chemistry</p>
               </a>
               <a href="#">
                  <img src="images/c-ico4.png">
                  <p>Biology</p>
               </a>
            </div>
         </div>
...
<section class="f-diff">
   <div class="cust-container1">
      <div class="row">
         <div class="col-md-12">
            <div class="m-cont">
               <h5>The <span><img src="images/fglogo.png"></span> Difference</h5>
               <div class="lap-img">
...
$args_query = array(
	'post_type' => array('post','candidates'),
	'order' => 'DESC',
);